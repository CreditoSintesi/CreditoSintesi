...
<!--/.navbar-collapse -->
  <div class="container">
     <!-- Service Tabs -->
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header"> Rutina XXX - Dia X - Pecho</h2>
            </div>
      </div>
  </div>      
        ...
        <div class="col-md-4">
          ...
          <div class="col-md-4">
            <ul class="list-inline social-buttons">
             <li><a href=""><img src="media/img/social/twitter2.png" width="42px" align="42px" ></a></li>
             <li><a href=""><img src="media/img/social/face2.png" width="42px" align="42px"></i></a></li>
             <li><a href=""><img src="media/img/social/insta2.png" width="42px" align="42px"></i></a></li>
            </ul>
          </div>
          <div class="col-md-4">
