<?php 
	...
	extract($_POST);
	$updt_user_sql = "UPDATE `tbl_usuario` SET `nombre_usuario` = '".$ch_name."', `email_usuario` = '".$ch_mail."', `apellidos_usuario` = '".$ch_lastname."', `altura_usuario` = '".$ch_tall."', `id_objetivo` = '".$ch_objective."', `id_tipo_cuerpo` = '".$ch_type_body."' WHERE `tbl_usuario`.`id_usuario` = ".$_SESSION['id_usuario'].";";
