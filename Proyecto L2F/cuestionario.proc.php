<?php
	...
	$consulta = "UPDATE tbl_usuario SET id_objetivo = '$id_objetivo', apellidos_usuario = '$apellidos_usuario', sexo_usuario = '$sexo_usuario', altura_usuario = '$altura_usuario', fecha_nacimiento = '$fecha_nacimiento', id_tipo_cuerpo = $id_tipo_cuerpo, estado_usuario = 'Activo' WHERE id_usuario = $id_usuario;" ; 
	//echo $consulta;die;
